module.exports = {
	HTML: function (header, footer, title, name, date, time, contents, writer_email, queryData_id, queryData_email) {
	   return`
	   <!doctype html>
  <html lang="en">
  <head>
	 ...
	 <section class="steps__box">
		<div class="container">
		  <div class="page-section text-center">
			<h2 class="page-section__title">${name}</h2>
			...
			<div class="row">
			  <div class="col-md-6">
				<div class="text-center steps__single steps__single-first">
				  ...
				  <a class="button" href="/hero/hero_management/update?id=${queryData_id}&email=${queryData_email}&writer_email=${writer_email}">MODIFY</a>
				</div>
			  </div>
			  <div class="col-md-6">
				<div class="text-center steps__single">
				  ...
				  <a class="button" href="/hero/hero_management/delete_process?id=${queryData_id}&email=${queryData_email}&writer_email=${writer_email}">DELETE</a>
				</div>
			  </div>
			</div>
