module.exports = {
  HTML: function (header, footer, title, team, date, time, contents, writer_email, queryData_id, queryData_email) {
     return`
     <!doctype html>
<html lang="en">
<head>
...
<body>
 <div id="content-wrapper">
  <header class="header header--bg">
   ...
   <section class="steps__box">
      <div class="container">
        <div class="page-section text-center">
          <h2 class="page-section__title">${team}</h2>
          <div class="page-section__title-style">
            <span class="first-line"></span>
            <span class="second-line"></span>
          </div>
          <p class="page-section__subtitle">${title}</p>
          <div class="row">
            <div class="col-md-6">
              <div class="text-center steps__single steps__single-first">
                <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/modify.png" alt="" width="30%" height="30%">
                <p>권한을 가진 사용자만이 수정할 수 있습니다</p>
                <a class="button" href="/matching/matching_management/update?id=${queryData_id}&email=${queryData_email}&writer_email=${writer_email}">MODIFY</a>
              </div>
            </div>
            <div class="col-md-6">
              <div class="text-center steps__single">
                <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/delete.png" alt="" width="30%" height="30%">
                <p>권한을 가진 사용자만이 삭제할 수 있습니다</p>
                <a class="button" href="/matching/matching_management/delete_process?id=${queryData_id}&email=${queryData_email}&writer_email=${writer_email}">DELETE</a>
              </div>
            </div>
          </div>
