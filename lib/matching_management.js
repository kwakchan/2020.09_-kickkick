module.exports = {
  HTML: function (title, team, date, time, contents, writer_email, queryData_id, queryData_email) {
     return`
     <!doctype html>
<html lang="en">
<head>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="text-center steps__single steps__single-first">
                ...
                <a class="button" href="/matching/matching_management/password?id=${queryData_id}&email=${queryData_email}&writer_email=${writer_email}">MODIFY</a>
              </div>
            </div>
            <div class="col-md-6">
              <div class="text-center steps__single">
                ...
                <a class="button" href="/matching/matching_management/delete_process?id=${queryData_id}">DELETE</a>
              </div>
            </div>
          </div>
