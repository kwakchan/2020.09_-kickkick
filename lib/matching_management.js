    ...
    <body>
      <form action="#.php" id="pop-up">  
          ...
          <tr>
            ...
            <td>
               <!--  <a href="/matching/matching_management/update?id=${queryData_id}"> -->
                <a href="/hero/hero_management/password?id=${queryData_id}&email=${queryData_email}&writer_email=${writer_email}">  
                  <img data-role="button" src="http://localhost:3000/img/modify.png" height="30px" width="30px">
                </a>
            </td>
            <td>
                <a href="/matching/matching_management/delete_process?id=${queryData_id}">
                  <img data-role="button" src="http://localhost:3000/img/delete.png" height="30px" width="30px"> 
                </a>
            </td>
          </tr>
        </table>
        ...
        <table id="table2">           
            ...
            <tr>
					    <td colspan="2"></td>
					    <td colspan="2"> <input type="hidden" class=form value="${writer_email}" readonly> </td>
				    </tr>
