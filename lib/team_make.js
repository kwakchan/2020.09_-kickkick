module.exports = {
	HTML: function (header, footer, queryData_email, dup) {
	   return`
	   <!doctype html>
  <html lang="en">
  <head>
	   ...
	   <div class="container">
		 <div class="page-section">
		   <div class="text-center">
			 ...
			 <p class="page-section__subtitle page-section__subtitle--white">팀정보를 작성해주세요</p>
		   </div>
         ...
         ${dup}
			 ...
			 <div class="form-group">
			   <input class="form-control" type="text" placeholder="Area" name='area'>
			 </div>

			 <div class="row">
			 <div class="col-md-12 form-button">
			   <input class="button--form" type="submit" value="CREATE">
			 </div>
			 </div>
		   </form>
		 </div>
