      ...
      detail = detail +
        ...
        <div class="collapse" id="no${i}">
          <div class="collapse__wrapper">
            ...
            <p class="paragraph">${topics[i].writer_email}</p>
            <p class="paragraph">${topics[i].date}</p>
            <p class="paragraph">${topics[i].time}</p>
            <p class="paragraph">${topics[i].contents}</p>
          </div>
        </div>
        `;
      i = i + 1;
          ...
          <div class="bio">
            <table>
                <tr>
                  ...
                  <th colspan="2"> <h2>${topics[i].team}</h2> </th>
                </tr>
                <tr>
                  <td colspan="2"> <p>${topics[i].title}</p> </td>
                </tr>
                <tr>
                  <td colspan="2"> <p>${topics[i].date}</p> </td>
                </tr>
                <tr>
                  <td colspan="2"> <p>${topics[i].time}</p> </td>
                </tr>
            </table>
          </div>
        </button>`;
