      ...
      <div data-role="page" id="bar">	
          ...
          <div data-role="content" id="content"> 
            ...
            <table class="matching-create" style="width: 100%; height: 20%; text-align: center;">
              <tr>
                  <th class="tg-c3ow" colspan="2" rowspan="2"> <img src="https://raw.githubusercontent.com/kimxminsu/kickkick/minsu/app/img/%EC%8B%B8%EC%BB%A4%ED%82%A5.png" id="matching-logo" weight='120px' height='120px'> </th>
    ...
    while (i < topics.length) {
      list = list +
        `<tr>
          ...
          <td class="tg-0lax"> <a href='/matching/matching_management?id=${topics[i].id}'"> ${topics[i].title} </a></td>
        </tr>`;
      i = i + 1;
    }
    // list = list+'</tr>';
