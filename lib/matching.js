module.exports = {
  HTML: function (header, footer, list, detail, count, queryData_email) {
    return `
     <!doctype html>
<html lang="en">
<head>
...
<body>
   ...
   <div class="container">
     <div class="page-section">
       <div class="text-center">
         <h2 class="page-section__title">Matching</h2>
         <div class="testimonial__title-style">
           <span class="first-line"></span>
           <span class="second-line"></span>
         </div>
         <p class="page-section__subtitle">회원님을 기다리는 매칭이 <a href="">${count}</a> 개 있습니다</p>
         <a class="button" href="/matching/matching_make?email=${queryData_email}">CREATE</a>
         <br><br>
       </div>
       <div class="row">
         <div class="col-md-8">
 ...
 <script>
  ...
  //matching_detail
  detail: function (topics, queryData_email) {
    var detail = '';
    var i = 0;
    while (i < topics.length) {
      detail = detail +
        `
        <div class="collapse" id="no${i}">
          <div class="collapse__wrapper">
            <a href='/matching/matching_management/password?id=${topics[i].id}&email=${queryData_email}&writer_email=${topics[i].writer_email}'" class="header__button" > 관리 </a>
            <div class="bio bio-1">
              <table>
                  <tr>
                    <td rowspan="2"> <img id="team_image" src="http://202.30.32.218:3000/uploads/${topics[i].team_image}" alt="" width="100em" height="100em"></td>
                    <td> <h2>${topics[i].team}</h2> </td>
                  </tr>
                  <tr>
                    <td> <p>${topics[i].title}</p>  </td>
                  </tr>
              </table>
            </div>
            ...
            작성자 : <p class="paragraph">${topics[i].writer_email}</p>
            날짜 : <p class="paragraph">${topics[i].date}</p>
            시간 : <p class="paragraph">${topics[i].time}</p>
            내용 : <p class="paragraph">${topics[i].contents}</p>
          </div>
        </div>
        `;
      i = i + 1;
  ...
  list: function (topics, queryData_email) {
    ...
    while (i < topics.length) {
      list = list +
        `<button class="button-testimonial button-testimonial-1" data-toggle="collapse" data-target="#no${i}">
          <div class="bio">
            <table>
                <tr>
                  <th colspan="2" rowspan="4"> <img id="team_image" src="http://202.30.32.218:3000/uploads/${topics[i].team_image}" alt="" width="100em" height="100em"></th>
                  <th colspan="2"> <h2>팀 : ${topics[i].team}</h2> </th>
                </tr>
                <tr>
                  <td colspan="2"> <p>제목 : ${topics[i].title}</p> </td>
                </tr>
                <tr>
                  <td colspan="2"> <p>날짜 : ${topics[i].date}</p> </td>
                </tr>
                <tr>
                  <td colspan="2"> <p>시간 : ${topics[i].time}</p> </td>
                </tr>
            </table>
          </div>
        </button>`;
