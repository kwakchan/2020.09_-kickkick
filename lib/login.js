    ...
    <div class="container">
      <div class="page-section">
        ...
        <form action="/login/login_process" method="post">
            ...
            <div class="form-group">
                <input type="hidden" class="btnSubmit" value="" onClick="location.href= 'login/login_register' "/>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 form-button">
              <input class="button--form" type="button" value="REGISTER" onClick="location.href= 'login/login_register' ">
            </div>
          </div>
        </form>
      </div>
