module.exports = {
  ...
  */
  ...
  .navbar-brand{
    background: url("https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/back.png") left center no-repeat;
    padding:0px 90px;
  }
    ...
    <div class="container">
      <div class="page-section">
        <div class="text-center">
          ...
          <p class="page-section__subtitle"><a href="">KICKKICK</a> 서비스를 이용하기 위해서는 <a href="">로그인</a>이 필요합니다</p>
        </div>
        <form action="/login" method="post">
            ...
            <div class="form-group">
                <a href="#" class="ForgetPwd">${dup}</a>
            </div>

            <div class="form-group">
                <input type="hidden" class="btnSubmit" value="" onClick="location.href= '/login_register' "/>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 form-button">
              <input class="button--form" type="button" value="REGISTER" onClick="location.href= '/login_register' ">
            </div>
          </div>
        </form>
      </div>
