...
@font-face {
 ...
 .header--bg{
     background: url("https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/header-background.png") ;
  ...
  <div id="content-wrapper">
    <header class="header header--bg">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img class="img-responsive" src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/running-man.png" width="100%" alt="">
          </div>
