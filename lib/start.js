...
<head>
  ...
  <title>KICKKICK by ksu-islandTeam</title>
...
@font-face {
 ...
 .header--bg{
     background: url("https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/header-background.png") left center no-repeat;
 ...
 .form--bg{
     background: url("https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/form-background.png") left center no-repeat;
     background-size: cover;
   }
  ...
  <div id="content-wrapper">
    <header class="header header--bg">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img class="img-responsive" src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/running-man.png" alt="">
          </div>
          <div class="col-lg-6 header__content">
            <h1 class="title">Welcome to KickKick<span class="title-style"></span></h1>
            <p style="font-family:Nanum Gothic;"> 축구는 하고싶은데 방법을 몰라 헤매고 계시나요 ? <br> 저희 킥킥에서 도와드리겠습니다 </p>
            <a class="header__button" href="login">LOGIN</a>
            <a class="header__button" href="login_register">REGISTER</a>
          </div>
        </div>
      </div>
    </header>
    ...
    <div class="container">
      <div class="page-section text-center">
        <h2 class="page-section__title">GOAL</h2>
        <div class="page-section__title-style">
          <span class="first-line"></span>
          <span class="second-line"></span>
        </div>
        <p class="page-section__subtitle" style="font-family:Nanum Gothic;">간단하고 편리한 축구 매칭을 제공해드리겠습니다</p>
        <div class="row">
          <div class="col-md-4">
            <div class="text-center steps__single steps__single-first">
              <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/step1.png" alt="">
              <p>For User</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="text-center steps__single">
              <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/step2.png" alt="">
              <p>Feedback</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="text-center steps__single steps__single-last">
              <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/step3.png" alt="">
              <p>Smooth Service</p>
            </div>
          </div>
        </div>
        <a class="button" href="/login">TRY NOW</a>
      </div>
    </div>
  </section>
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="video__right text-center">
                <h2 class="video__title">Gender Equality</h2>
                <div class="video__title-style">
                  <span class="first-line"></span>
                  <span class="second-line"></span>
                </div>
                <p style="font-family:Nanum Gothic;">남여 구분없이 모두가 이용할 수 있는 환경을 만들겠습니다</p>
                <a class="button button--white" href="/login">TRY NOW</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DsGSUryITXs" frameborder="0" allowfullscreen="" id="video"  allowscriptaccess="always"></iframe>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-2 sponsors__single">
            <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/sponsors1.png" alt="">
          </div>
          <div class="col-lg-2 sponsors__single">
            <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/sponsors2.png" alt="">
          </div>
           <div class="col-lg-2 sponsors__single">
            <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/sponsors3.png" alt="">
          </div>
           <div class="col-lg-2 sponsors__single">
            <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/sponsors4.png" alt="">
          </div>
           <div class="col-lg-2 sponsors__single">
            <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/sponsors5.png" alt="">
          </div>
           <div class="col-lg-2 sponsors__single">
            <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/sponsors6.png" alt="">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            <h2 class="page-section__title">Island Team</h2>
            <div class="team__title-style">
              <span class="first-line"></span>
              <span class="second-line"></span>
            </div>
            <p class="page-section__subtitle" style="font-family:Nanum Gothic;">스포츠 대결 매칭 앱 개발</p>
          </div>
          <div class="row gutters-80">
            <div class="col-md-4">
              <div class="thumbnail team__single">
                <div class="bio text-center">
                  <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/team1.png" alt="">
                  <h2>곽 찬</h2>
                  <p>Software Developer</p>
                </div>
                <div class="caption">
                  <p style="font-family:Nanum Gothic;">세상의 부족한 점을 관심가지고 나의 자산으로 변화하고자 하는 나</p>
            ...
            <div class="col-md-4">
              <div class="thumbnail team__single">
                <div class="bio text-center">
                  <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/team2.png" alt="">
                  <h2 style="font-family:Nanum Gothic;">김 민 수</h2>
                  <p>Software Developer</p>
                </div>
                <div class="caption">
                  <p style="font-family:Nanum Gothic;">불편사항을 해소해주고, 남의 의견을 수용 할 줄 아는 개발자</p>
                  <div class="social-icons">
                    <li><a href="#"><i class="flaticon-facebook-letter-logo"></i></a></li>
                    <li><a href="#"><i class="flaticon-twitter-logo-silhouette"></i></a></li>
                    <li><a href="#"><i class="flaticon-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
              <div class="thumbnail team__single">
                <div class="bio text-center">
                  <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/team3.png" alt="">
                  <h2 style="font-family:Nanum Gothic;">임 상 운</h2>
                  <p>Software Developer</p>
                </div>
                <div class="caption">
                  <p style="font-family:Nanum Gothic;">많은 사람들이 필요로하지만 세상에 존재하지 않는 것들을 만들어내는 나</p>
                  <div class="social-icons">
                    <li><a href="#"><i class="flaticon-facebook-letter-logo"></i></a></li>
                    <li><a href="#"><i class="flaticon-twitter-logo-silhouette"></i></a></li>
                    <li><a href="#"><i class="flaticon-google-plus"></i></a></li>
