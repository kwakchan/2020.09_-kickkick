module.exports = {
	HTML: function (header, footer, users_team, list, team_image, count, queryData_email) {
	   return`
	   <!doctype html>
  <html lang="en">
  <head>
      ...
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            <h2 class="page-section__title">Team Member</h2>
            <div class="team__title-style">
              <span class="first-line"></span>
              <span class="second-line"></span>
            </div>
            <p class="page-section__subtitle"> <a href="">${users_team}</a>팀에는 <a href="">${count}</a> 명의 선수가 뛰고 있습니다</p>
          </div>
