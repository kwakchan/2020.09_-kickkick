...
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
 ...
 function nameNull()
 {
  swal ( "Oops" ,  "이름을 입력해주세요" ,  "error" )
 };
 </script>
 <script>
 function emailNull()
 {
  swal ( "Oops" ,  "이메일을 입력해주세요" ,  "error" )
 };
 </script>
 <script>
 function emailForm()
 {
  swal ( "Oops" ,  "이메일 형식에 맞게 입력해주세요" ,  "error" )
 };
 </script>
 <script>
 function pwNull()
 ...
 function pwForm()
 {
  swal ( "Oops" ,  "비밀번호 형식에 맞게 입력해주세요" ,  "error" )
 };
 </script>
 <script>
 function pwReNull()
 {
  swal ( "Oops" ,  "비밀번호를 확인란을 입력해주세요" ,  "error" )
 };
 </script>
 <script>
 function pwDif()
 {
  swal ( "Oops" ,  "두 비밀번호가 일치하지 않습니다" ,  "error" )
 };
 </script>
    ...
    <div class="page-section">
      ...
      <form action="/login_register" method="post" onsubmit="return checks()">
          <div class="form-group">
              <input type="text" class="form-control" width="50%" name="name" placeholder="Name *" value="" id="name"/>
          </div>
          <div class="form-group">
              <input type="email" class="form-control" name="email" placeholder="Your Email *" value="" id="email"/>
              &nbsp;&nbsp;${dup}
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              <input type="password" class="form-control" name="password2" placeholder="Confirm Password *" value="" id="password_check"/>
          </div>
          <div class="form-group">
              <div class="maxl">
