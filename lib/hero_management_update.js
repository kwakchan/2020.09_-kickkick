		...
		<form action="/hero/hero_management/update_process?id=${queryData_id}" method="post" id="pop-up">
			<table id="table2"> 
				...
				<tr>
					...
					<td colspan="2"> <input type="text" class=form value="${name}" name='update_name' readonly> </td>
				</tr>
				...
				<tr>
					<td colspan="2">내용</td>
					<td colspan="2"> <input type="text" class=form value="${contents}" name='update_contents'> </td>
				</tr>
