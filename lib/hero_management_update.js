module.exports = {
	HTML: function (header, footer, title, name, date, time, contents, queryData_id, queryData_email) {
	   return`
	   <!doctype html>
  <html lang="en">
  <head>
	 ...
	 <section class="form form--bg">
	   <div class="container">
		 <div class="page-section">
		   ...
		   <form action="/hero/hero_management/update_process?id=${queryData_id}&email=${queryData_email}" method="post" id="pop-up">
			 <div class="form-group">
			   <input class="form-control" type="text" value="${title}" name='update_title'>
			 </div>
			 <div class="form-group">
			   <input class="form-control" type="text" value="${name}" name='update_name'>
			 </div>
			 <div class="form-group">
