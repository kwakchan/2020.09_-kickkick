			...
			<div data-role="content" id="content"> 
				<div style="width: 100%; height: 100%;">   
					<table class="matching-create" style="width: 100%; height: 20%; text-align: center;">
						<tr>
							<th class="tg-c3ow" colspan="2" rowspan="2"> <img src="https://raw.githubusercontent.com/kimxminsu/kickkick/minsu/app/img/%EC%9A%A9%EB%B3%91%20%EB%A1%9C%EA%B3%A0.png" id="matching-logo" weight='120px' height='120px'> </th>
					...
					<form action="/hero_search?email=${queryData_email}" method="post">
					  <table class="matching-list" style="width: 100%; height: 100%; text-align: center;">
						<thead>
							...
							<th align="center" style="width: 8em"> 
								<input type="submit" id="matching-search" value="검색">
							</th>
						</thead>
