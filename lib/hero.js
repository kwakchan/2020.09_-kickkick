		  ...
		  <div class="collapse" id="no${i}">
				<div class="collapse__wrapper">
					...
					<div class="bio bio-1">
						<table>
							<tr>
								<td rowspan="2"> <img id="user_image" src="http://localhost:3000/uploads/${topics[i].image}" alt="" width="100em" height="100em"></td>
		  ...
		  list = list +
			`<button class="button-testimonial button-testimonial-1" data-toggle="collapse" data-target="#no${i}">
				<div class="bio">
					<table>
						<tr>
							<th colspan="2" rowspan="4"> <img id="user_image" src="http://localhost:3000/uploads/${topics[i].image}" alt="" width="100em" height="100em"></th>
