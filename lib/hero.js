	 ...
	 <div class="container">
	   <div class="page-section">
		 <div class="text-center">
		   <h2 class="page-section__title">HERO</h2>
		   <div class="testimonial__title-style">
			 <span class="first-line"></span>
			 <span class="second-line"></span>
		   </div>
		   <p class="page-section__subtitle">회원님을 기다리는 용병이 <a href="#">${count}</a> 명 있습니다</p>
		   <a class="button" href="/hero/hero_make?email=${queryData_email}">CREATE</a>
		   <br><br>
		 </div>
		 <div class="row">
		   <div class="col-md-8">
		...
		while (i < topics.length) {
		  ...
		  <div class="collapse" id="no${i}">
			  <div class="collapse__wrapper">
				 <a href='/hero/hero_management/password?id=${topics[i].id}&email=${queryData_email}&writer_email=${topics[i].writer_email}'" class="header__button" > 관리 </a>
				 <div class="bio bio-1">
					<table>
					   <tr>
						  <td rowspan="2"> <img id="user_image" src="http://202.30.32.218:3000/uploads/${topics[i].image}" alt="" width="100em" height="100em"></td>
						  <td> <h2>${topics[i].name}</h2> </td>
					   </tr>
					   <tr>
		...
		while (i < topics.length) {
			list = list +
			  ...
			  <div class="bio">
				 <table>
					<tr>
					   <th colspan="2" rowspan="4"> <img id="user_image" src="http://202.30.32.218:3000/uploads/${topics[i].image}" alt="" width="100em" height="100em"></th>
					   <th colspan="2"> <h2>이름 : ${topics[i].name}</h2> </th>
					</tr>
					<tr>
