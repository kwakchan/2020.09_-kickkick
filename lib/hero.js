			...
			<table class="matching-create" style="width: 100%; height: 20%; text-align: center;">
				<tr>
					<th class="tg-c3ow" colspan="2" rowspan="2"> 
						<img src="https://raw.githubusercontent.com/kimxminsu/kickkick/minsu/app/img/%EC%9A%A9%EB%B3%91%20%EB%A1%9C%EA%B3%A0.png" id="matching-logo" weight='120px' height='120px'> 
					</th>
					<th class="tg-c3ow" colspan="6" id="title">  <br>용병구함</th>
				</tr>
				<tr>
				<td class="tg-c3ow" colspan="3"> <button type="button" method="post" id="btn2"  onclick="location.href='/hero/hero_make?email=${queryData_email}'">만들기</button> </td>
