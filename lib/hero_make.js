module.exports = {
	HTML: function (header, footer, users, queryData_email) {
	   return`
	   <!doctype html>
  <html lang="en">
  <head>
	   ...
	   <div class="container">
		 <div class="page-section">
		   <div class="text-center">
			 <h2 class="page-section__title page-section__title--white">CREATE</h2>
			 <div class="form__title-style">
			   <span class="first-line"></span>
			   <span class="second-line"></span>
			 </div>
			 <p class="page-section__subtitle page-section__subtitle--white">내용을 작성해주세요</p>
		   </div>
  
		   <form action="/hero/create_process?email=${queryData_email}" method="post" id="pop-up">
			 <div class="form-group">
			   <input class="form-control" type="hidden" value="${users[0].email}" name='writer_email'>
			 </div>
			 <div class="form-group">
			   <input class="form-control" type="text" placeholder="Title" name='form_title'>
			 </div>
			 <div class="form-group">
			   <input class="form-control" type="text" value="${users[0].name}" name='form_name' readonly>
			 </div>
			 <div class="form-group">
			   <input class="form-control" type="date" placeholder="Date" name='form_date'>
			 </div>
			 <div class="form-group">
			   <input class="form-control" type="time" placeholder="Time" name='form_time'>
			 </div>
			 <div class="form-group">
				<textarea class="form-control" rows="5" placeholder="Contents" name='form_contents'></textarea>
			 </div>
			 <div class="row">
			 <div class="col-md-12 form-button">
			   <input class="button--form" type="submit" value="SAVE">
			 </div>
			 </div>
		   </form>
		 </div>
