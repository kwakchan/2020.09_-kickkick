module.exports = {
   HTML: function (header, footer, users, queryData_email, image) {
      return `
   <!DOCTYPE html>
   <html>
      ...
      <div data-role="page" id="bar">   
         ...
         <div data-role="content" id="content">
            ...
            <table style="width: 100%; height: 100%;">
               <tr>
                  <td colspan="2" align="center"> <div id="click_btn2" style="border:1px solid DodgerBlue;">프로필 사진 변경</div> <td>
               </tr>

               <tr>
                  <td class="text">이름</td>
                  <td class="text">${users[0].name}</td>
               </tr>
               <tr>
                  <td class="text">나이</td>
                  <td class="text">${users[0].age}</td>
               </tr>
            
               <tr>
                  <td class="text">소속</td>
                  <td class="text">${users[0].team}</td>
               </tr>      
            
               <tr>
                  <td class="text">포지션</td>
                  <td class="text">${users[0].position}</td>
               </tr>
               <tr>
                  <td class="text">키</td>
                  <td class="text">${users[0].height}</td>
               </tr>
               <tr>
                  <td class="text">몸무게</td>
                  <td class="text">${users[0].weight}</td>
               </tr>
               ...
               <tr>
                  <td colspan="2" align="center"> <a href="/user/update?email=${queryData_email}" id="click_btn3" style="border:1px solid DodgerBlue;"> 수정</a> </td>
               <tr>   

               <tr>
                  <td colspan="2" align="center"> <a href="/user/logout_process" id="click_btn3" style="border:1px solid DodgerBlue;"> 로그아웃</a> </td>
               </tr>
            </table>
