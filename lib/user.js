      ...
      <div data-role="page" id="bar">	
         ...
         <div data-role="content" id="content">
            ...
            <table style="width: 100%; height: 100%;">
               <tr>
                  <td colspan="3" align="center"> <img src="http://localhost:3000/uploads/${image_name}" width="100em" height="100em"/> </td>
               </tr>
               
               <form action="/upload?email=${queryData_email}" method="post" enctype="multipart/form-data">
                  <tr align="center"> 
                     <td colspan="1"> <input type="file" id="click_btn2" name='userfile' /> </td> 
                     <td colspan="1"> <input type="submit" id="click_btn3" style="border:1px solid DodgerBlue;" /> </td>
                  </tr>   
               </form>

               <tr>
                  <td class="text">이름</td>
                  <td class="text" colspan="2">${users[0].name}</td>
               </tr>

               <tr>
                  <td class="text">나이</td>
                  <td class="text" colspan="2">${users[0].age}</td>
               </tr>

               <tr>
                  <td class="text">소속</td>
                  <td class="text" colspan="2">${users[0].team}</td>
               </tr>      
            
               <tr>
                  <td class="text">포지션</td>
                  <td class="text" colspan="2">${users[0].position}</td>
               </tr>
               <tr>
                  <td class="text">키</td>
                  <td class="text" colspan="2">${users[0].height}</td>
               </tr>
               <tr>
                  <td class="text">몸무게</td>
                  <td class="text" colspan="2">${users[0].weight}</td>
               </tr>
               
               <tr>
                  <td class="text">알림</td>
                  <td class="text" colspan="2"> <div class="switcher"> <input type="checkbox" id="switcher-1" data-title1="on" data-title2="off" /> <label for="switcher-1"></label> </div></td>
               </tr>
               ...
               <tr>
                  <td colspan="3" align="center"> <a href="/user/update?email=${queryData_email}" id="click_btn3" style="border:1px solid DodgerBlue;"> 수정</a> </td>
               <tr>   

               <tr>
                  <td colspan="3" align="center"> <a href="/user/logout_process" id="click_btn3" style="border:1px solid DodgerBlue;"> 로그아웃</a> </td>
               </tr>
            </table>         
         </div>   
