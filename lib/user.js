   ...
   <div class="container">
     <div class="page-section">
       <div class="text-center">
         ...
         <img id="user_image" src="http://localhost:3000/uploads/${image_name}" alt="" width="150em" height="150em">
       ...
       <form>
         <div class="form-group">
           <input class="form-control" type="text" name="positon" value=${users[0].position} readonly>
         </div>
         <div class="form-group">
           <input class="form-control" type="text" name="age" value=${users[0].age} readonly>
         </div>
         <div class="form-group">
           <input class="form-control" type="text" name="height" value=${users[0].height} readonly>
         </div>
         <div class="form-group">
           <input class="form-control" type="text" name="weight" value=${users[0].weight} readonly>
         </div>
