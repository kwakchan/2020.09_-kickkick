module.exports = {
   HTML: function (header, footer, queryData_id, queryData_email, queryData_write_email, dup) {
      return`
      <!doctype html>
 <html lang="en">
 <head>
  ...
  <div id="content-wrapper">
   ...
   <div class="container">
     <div class="page-section">
       ...
       <form action="/matching/matching_management/password_process?id=${queryData_id}&email=${queryData_email}&writer_email=${queryData_write_email}" method="post" id="pop-up">
