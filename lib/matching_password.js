module.exports = {
  HTML: function (header, footer, queryData_id, queryData_email, queryData_writer_email, dup) {
     return`
     <!doctype html>
<html lang="en">
<head>
  ...
  <div class="container">
    <div class="page-section">
      <div class="text-center">
        <h2 class="page-section__title">PASSWORD</h2>
        <div class="form__title-style">
          <span class="first-line"></span>
          <span class="second-line"></span>
        </div>
        <p class="page-section__subtitle">비밀번호를 입력해주세요</p>
      </div>
      <form action="/matching/matching_management/password_process?id=${queryData_id}&email=${queryData_email}&writer_email=${queryData_writer_email}" method="post" id="pop-up">
