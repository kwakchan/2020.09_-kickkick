module.exports = {
  HTML: function (header, footer, title, team, date, time, contents, queryData_id, queryData_email) {
     return`
     <!doctype html>
<html lang="en">
<head>
     ...
     <div class="container">
       <div class="page-section">
         <div class="text-center">
           <h2 class="page-section__title page-section__title--white">MODIFY</h2>
           <div class="form__title-style">
             <span class="first-line"></span>
             <span class="second-line"></span>
           </div>
           <p class="page-section__subtitle page-section__subtitle--white">내용을 수정해주세요</p>
         </div>

         <form action="/matching/matching_management/update_process?id=${queryData_id}&email=${queryData_email}" method="post" id="pop-up">
           <div class="form-group">
             <input class="form-control" type="text" value="${title}" name='update_title'>
           </div>
           <div class="form-group">
             <input class="form-control" type="text" value="${team}" name='update_team' readonly>
           </div>
           <div class="form-group">
             <input class="form-control" type="date" value="${date}" name='update_date'>
           </div>
           <div class="form-group">
             <input class="form-control" type="time" value="${time}" name='update_time'>
           </div>
           <div class="form-group">
              
              <textarea class="form-control" rows="5" name='update_contents'>${contents}</textarea>
           </div>
           <div class="row">
