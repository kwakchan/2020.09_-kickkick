module.exports = {
	HTML: function (header, footer, queryData_email, list, dup, count) {
	   return`
	   <!doctype html>
  <html lang="en">
  <head>
  ...
  <body>
	   ...
	   <div class="container">
		 <div class="page-section">
		   <div class="text-center">
			 <h2 class="page-section__title page-section__title--white">JOIN</h2>
			 <div class="form__title-style">
			   <span class="first-line"></span>
			   <span class="second-line"></span>
			 </div>
			 <p class="page-section__subtitle page-section__subtitle--white">가입하려는 팀명을 입력하세요</p>
		   </div>
  
		   <form action="/team/team_register_process?email=${queryData_email}" method="post">
			 <div class="form-group">
         <input class="form-control" type="text" placeholder="Team Name" name='team_name'>
         ${dup}
			 </div>

			 <div class="row">
			 <div class="col-md-12 form-button">
			   <input class="button--form" type="submit" value="JOIN">
			 </div>
			 </div>
		   </form>
		 </div>
   ...
   <section class="team team--bg">
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            <h2 class="page-section__title">Team List</h2>
            <div class="team__title-style">
              <span class="first-line"></span>
              <span class="second-line"></span>
            </div>
            <p class="page-section__subtitle">회원님을 기다리는 팀이 <a href="">${count}</a> 개 있습니다</p>
          </div>
