module.exports = {
   HTML: function (header, footer, queryData_email, users, user_image, team_image) {
      return`
      <!doctype html>
 <html lang="en">
 <head>
         ...
         <div class="page-section text-center">
           ...
           <div class="bio text-center">
            <a href="/team/team_mymember?email=${queryData_email}">
                <img id="team_image" src="http://202.30.32.218:3000/uploads/${team_image}" alt="" width="150em" height="150em">
            </a>
            <h2>${users[0].team}</h2>
            <p>${users[0].name}</p>
           </div>
           ...
           <form action="/team_upload?email=${queryData_email}" method="post" enctype="multipart/form-data">
            <div id="file_upload"> 
              <input type="file" class="btn btn-primary btn-sm float-left" name='userfile' /> 
              <input type="submit" class="btn btn-outline-primary" style="border:1px solid DodgerBlue;" /> 
            </div>   
           </form> 
           ...
           <div class="row">
             <div class="col-md-6">
               <div class="text-center steps__single steps__single-first">
                 ...
                 <p>팀을 만들어보세요</p>
                 <a class="button" href="/team/team_make?email=${queryData_email}">CREATE</a>
               </div>
             </div>
             <div class="col-md-6">
               <div class="text-center steps__single">
                 <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/join.png" alt="" width="30%" height="30%">
                 <p>팀을 가입해보세요</p>
                 <a class="button" href="/team/team_register?email=${queryData_email}">JOIN</a>
               </div>
             </div>
           </div>
