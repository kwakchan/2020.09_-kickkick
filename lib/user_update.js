module.exports = {
  HTML: function (header, footer, queryData_email, name, age, team, position, height, weight, gender) {
     return`
     <!doctype html>
<html lang="en">
<head>
  ...
  <div class="container">
    <div class="page-section">
      <div class="text-center">
        ...
        <p class="page-section__subtitle">정보를 수정해주세요</p>
      </div>
      <form action="/user/update_process?email=${queryData_email}" method="post" id="pop-up">
        <div class="form-group">
           이름<input class="form-control" type="text" name="update_name" value=${name}>
        </div>
        <div class="form-group">포지션
          <select name="update_position" value=${position}>
        ...
        <div class="form-group">
          나이<input class="form-control" type="date" name="update_age" value=${age}>
        </div>
        <div class="form-group">
          키<input class="form-control" type="number" name="update_height" value=${height}>
        </div>
        <div class="form-group">
          몸무게<input class="form-control" type="number" name="update_weight" value=${weight}>
        </div>
        <div class="form-group">성별
        <select name="update_gender" value=${gender}}>
