module.exports = {
   HTML: function (header, footer, queryData_email, name, age, team, position, height, weight) {
      return`
      <!doctype html>
 <html lang="en">
 <head>
     ...
     <div class="page-section">
       ...
       <form action="/user/update_process?email=${queryData_email}" method="post" id="pop-up">
         <div class="form-group">
            <input class="form-control" type="text" name="update_name" value=${name}>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
           <input class="form-control" type="date" name="update_age" value=${age}>
         </div>
         <div class="form-group">
           <input class="form-control" type="number" name="update_height" value=${height}>
         </div>
         <div class="form-group">
           <input class="form-control" type="number" name="update_weight" value=${weight}>
         </div>
