module.exports = {
    HTML: function (queryData_email, name, age, team, position, height, weight) {
      return `
       <!DOCTYPE html>
       <html>
       <meta charset="utf-8">
       ...
       <body>
          <div data-role="page" id="bar">   
             ...
             <div data-role="content" id="content">
                <div id="img">
                   <!-- <img src="https://raw.githubusercontent.com/kimxminsu/App_kickkick/minsu/img/profile.png" align="center" height="100px" align="center" alt="유저 이미지" title="유저 이미지"> -->
                </div>
          ...
          <form action="/user/update_process?email=${queryData_email}" method="post" id="pop-up">
            <table style="width: 100%; height: 100%;">
                <tr>
                    <td class="text">이름</td>
                    <td class="text"> <input type="text" value="${name}" name='update_name'> </td>
                </tr>
    
                <tr>
                    <td class="text">나이</td>
                    <td class="text"> <input type="text" value="${age}" name='update_age'> </td>
                </tr>
            
                <tr>
                    <td class="text">소속</td>
                    <td class="text"> <input type="text" value="${team}" name='update_team'> </td>
                </tr>      
            
                <tr>
                    <td class="text">포지션</td>
                    <td class="text"> <input type="text" value="${position}" name='update_position'> </td>
                </tr>
    
                <tr>
                    <td class="text">키</td>
                    <td class="text"> <input type="text" value="${height}" name='update_height'> </td>
                </tr>
    
                <tr>
                    <td class="text">몸무게</td>
                    <td class="text"> <input type="text" value="${weight}" name='update_weight'> </td>
                </tr>
                ...
                <tr>
                  ...
                  <input type="submit" id="click_btn3" style="border:1px solid DodgerBlue;" value="저장">
