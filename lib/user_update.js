               ...
               <form action="/user/update_process?email=${queryData_email}" method="post" id="pop-up">
                  <table style="width: 100%; height: 100%;">
                     ...
                     <tr>
                        ...
                        <td class="text"> 
                              <input type="date" value="${age}" name='update_age'>
                        </td>
                     </tr>
                  
                     <tr>
                        <td class="text">소속</td>
                        <td class="text"> <input type="text" value="${team}" name='update_team' readonly> </td>
                     </tr>      
                  
                     <tr>
                        <td class="text">포지션</td>
                        <td class="text">  
                              <select value="${position}" name='update_position'>
                     ...
                     <tr>
                        <td class="text">키(cm)</td>
                        <td class="text"> <input type="number" value="${height}" name='update_height'> </td>
                     </tr>
         
                     <tr>
                        <td class="text">몸무게(kg)</td>
                        <td class="text"> <input type="number" value="${weight}" name='update_weight'> </td>
                     </tr>
